...
enum clnt_stat 
set_value_1(SetValueArgs arg1, Response *clnt_res,  CLIENT *clnt)
{
...
enum clnt_stat 
delete_key_1(int arg1, Response *clnt_res,  CLIENT *clnt)
{
...
enum clnt_stat 
modify_value_1(SetValueArgs arg1, Response *clnt_res,  CLIENT *clnt)
{
